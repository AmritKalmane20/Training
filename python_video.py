...
Original file is located at
    https://colab.research.google.com/drive/1Zr2CcAJtaQkiRhAVnSeNluvwIStHyCJJ
"""
...
input_file = '/content/01c71072-718028b8.mp4'
subprocess.run(['ffmpeg','-i',
               input_file, '-qscale', '0'
               '01c71072-718028b.mp4',
               '-loglevel','quiet']
              )

!ls -GFlash --color

ipd.Video('/content/01c71072-718028b8.mp4', width=700,embed=True)

# Load in video capture
cap = cv2.VideoCapture('/content/01c71072-718028b8.mp4')
...
video_labels = (labels.query('videoName == "01c71072-718028b8"').reset_index(drop=True).copy())
